...
$MESS["PART_PAY"] = "Статус после частичной оплата заказа";
$MESS["PART_PAY_DESCR"] = "Статус заказа после оплаты только за доставку. Любой из кодов /bitrix/admin/sale_status.php (например N - принят, пусто - статус не меняется)";
